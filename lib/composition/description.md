...
#### Notes
Usually composition itself is immune / stateless, but parts can have internal state.
...
#### Difference between pipeline and functional composition.
- Pipeline - immediately executes operations on a specific value.
...
- Composition - creates a new reusable (function | object...) 
